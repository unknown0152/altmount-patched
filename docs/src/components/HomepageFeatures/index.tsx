  ...
  },
  {
    ...
    description: (
      <>
        ...
        Efficient connection pooling keeps latency low under heavy load.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Built-in Stremio addon with Prowlarr auto-search. Stream movies and TV directly in Stremio
        without any manual NZB handling — just search and play.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Connect multiple Usenet providers simultaneously. Automatic failover and load balancing
        ensure maximum completion rates and reliability.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Full support for NZB, RAR, nested RAR, multi-part archives, and password-protected archives.
        Transparent extraction so your apps see clean files.
      </>
    ),
  },
  {
